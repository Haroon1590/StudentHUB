            ...
            <div className="flex-1 flex flex-col">
                <div className="flex-1 p-8 custom-scrollbar overflow-y-auto">
                    <div className="max-w-3xl mx-auto">
                        <h1 className="text-3xl font-bold mb-6 text-[#E2E8F0] animate-fadeInUp">Assign Course</h1>

                        {message && (
                            <div className="bg-[#10B981] text-white p-4 rounded-lg mb-6 animate-slideInRight">
                                {message}
                            </div>
                        )}
                        ...
                        <div className="card-dark p-6 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
                            <h2 className="text-xl font-bold mb-4 text-[#E2E8F0]">Assign Course to Student</h2>
                            <form onSubmit={handleAssign} className="space-y-4">
                                <div>
                                    <label className="block mb-2 font-medium text-[#E2E8F0]">Select Student</label>
                                    <select
                                ...
                                <div>
                                    <label className="block mb-2 font-medium text-[#E2E8F0]">Select Course</label>
                                    <select
